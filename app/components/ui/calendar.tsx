  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-zinc-400 rounded-md w-10 md:w-8 font-normal text-[0.8rem]",
        ...
        day: cn(
          ...
          "h-10 w-10 md:h-8 md:w-8 p-0 font-normal aria-selected:opacity-100 text-zinc-300 hover:bg-zinc-800 hover:text-white focus:text-white"
        ),
